...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.colorGrey));
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.gradStart));
